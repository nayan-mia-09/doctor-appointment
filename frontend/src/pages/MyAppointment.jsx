            ...
            return (
             ...
             <p className='text-xs'>{address.line2 || "N/A"}</p>
              ...
              <div className='flex flex-col gap-2 justify-end'>
               {!item.cancelled && <button className='text-sm text-stone-500 text-center sm:min-w-48 py-2 border rounded hover:bg-pink-200 hover:text-black transition-all duration-300 cursor-pointer'>Pay Online</button> } 

...
const MyProfile = () => {
  ...
  <img className="w-36 rounded" src={userData.image} alt="" />
      ...
      <div className='mt-10'>
        {isEdit? 
        <button className='border border-pink-500 px-8 py-2 rounded-full hover:bg-pink-500 hover:text-white transition-all duration-300 cursor-pointer' onClick={updateUserProfileData}>Save information</button>
        : 
